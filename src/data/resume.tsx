...
export const DATA = {
  name: "Leonardo Aretakis",
  initials: "LA",
  url: "https://leoaretakis.github.io",
  location: "Lisbon, Portugal",
  locationLink: "https://www.google.com/maps/place/sanfrancisco",
  description:
    "Software Engineer. Ruby on Rails and React/Javascript specialist. I love coding, solving problems and helping people.",
  summary: [
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/leoaretakis",
        icon: Icons.github,
      ...
      SecondaryGitHub: {
        name: "GitHub",
        url: "https://github.com/leonardoaretakis",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/leonardo-aretakis-0b200423",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://twitter.com/leoaretakis",
        icon: Icons.x,
  ...
  work: [
    ...
    },
    {
      ...
      href: "http://www.quantumfinance.com.br/",
      badges: [],
      location: "Rio de Janeiro, Brazil",
      title: "Software Engineer",
      logoUrl: "/quantum.jpeg",
      start: "January 2012",
      end: "June 2013",
      description:
    ...
    {
      company: "Chemtech",
      href: "http://www.chemtech.com.br/",
      badges: [],
      location: "Rio de Janeiro, Brazil",
      title: "Junior Software Engineer",
      logoUrl: "/chemtech.jpeg",
      start: "January 2009",
      end: "October 2010",
      description:
        "Designed and implemented a robust password encryption and browser cookie storage system in Ruby on Rails. Leveraged the Yahoo finance API to develop the dividend.com equity screener",
    ...
    {
      company: "Dantas Property Evaluation Engineering",
      href: "http://dantas.eng.br/",
      badges: [],
    ...
    {
      company: "Pitang",
      href: "https://ig.rdstation.com/pitang_agileit",
      badges: [],
      location: "Recife, Brazil",
